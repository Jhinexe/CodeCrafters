...
INSERT INTO `cursos` (`id`, `nombre`, `profesor`, `duracion`, `descripcion`, `cantidad_alumnos`) VALUES
(1, 'Desarrollo Web', 'Juan Pérez', '40 horas', 'HTML, CSS y JavaScript desde cero', 25),
(2, 'Bases de Datos', 'María Soto', '30 horas', 'Modelado y gestión de bases de datos MySQL', 18),
(3, 'Programación con JavaScript', 'Carlos Rojas', '35 horas', 'Fundamentos y programación web moderna', 20);
